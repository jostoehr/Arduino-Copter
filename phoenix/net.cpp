...
/** Default constructor, initialize sockaddr_in with Port 7100
*/
Socket::Socket()
{
	data[0] = '\0';
...
/** Creates a new UDP Socket, binds it to the port and set it to non blocking mode
*/
void Socket::create()
{
...
/** Receiving Method to get a Command from the remote device
* parses the message after receiving it and returns the corresponding number (type)
*/
int Socket::get_cmd() {
...
/** Execution Method of a received Command
*/
